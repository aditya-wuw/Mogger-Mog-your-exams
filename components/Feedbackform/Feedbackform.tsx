...
const Feedbackform = () => {
  ...
  return (
    ...
    >
      {submitted ? (
        <motion.p
          className="text-green-950 font-medium p-3 bg-green-300/30 rounded-2xl"
        ...
        <form
          ...
          className="max-w-md mx-auto mt-10 p-3 bg-green-300/30 backdrop-blur-2xl shadow-lg rounded-lg md:w-100 w-[90vw]"
        >
